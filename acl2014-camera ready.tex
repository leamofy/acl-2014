...
\title{Are Two Heads are Better than One? Challenges for Crowdsourced Translation via a Two-Step Collaboration between Translators and Editors}

\title{Are Two Heads are Better than One? Crowdsourced Translation via a Two-Step Collaboration between Translators and Editors}
...
%  With appropriate quality control, we are able to distinguish acceptable translations from bad ones.  We demonstrate our model on the  Mechanical Turk translations of the NIST 2009 Urdu-to-English evaluation set, and show that our models are able to achieve better quality than previously published methods. 
\end{abstract}
...
In natural language processing, crowdsourcing translation has been examined to

building parallel corpora for machine translation systems \cite{ambati:10}
Arabic dialects \cite{Zbib-etal:2012:NAACL,zbib-EtAl:2013:NAACL-HLT}
Indian languages \cite{post-callisonburch-osborne:2012:WMT}

non-simulated active learning studies \cite{a7,AmbatiThesis,bloodgood-callisonburch:2010:ACL}

MTurk crowdsourcing platform 
seminal work by \newcite{Snow-et-al:EMNLP:2008}
wide variety of other speech and language applications \cite{callisonburch-dredze:2010:MTURK}
Language demographics \cite{Pavlick:2014}
Building a persistent multilingual workforce on MTurk \cite{chen:2011}

Professional quality translations from non-professionals \cite{zaidan-callisonburch:2011:ACL-HLT2011a}



In the HCI community,
several researchers have proposed protocols for collaborative translation efforts \cite{Morita:2009:PRIMA}.
% between people to get higher quality translations.
\cite{Morita:2009:IUI,Hu:2009,Hu:2010} Proposed an iterative collaboration between monolingual speakers of the two languages, facilitated with a machine translation system

International Children's Digital Library \cite{hourcade2003international}

\newcite{bernstein-et-al:2010} characterized the problems with hiring editors via MTurk for a word processing application.  Lazy workers or overly zealous editors, lead to find-fix-verify pattern.

Efficacy of monolingual or bilingual individuals post-editing of machine translation output
\newcite{callisonburch:2005:NIST,koehn:2010:NAACLHLT,Green:2013:EHP:2470654.2470718}

Sometimes automatically post-editing
\cite{Knight94automatedpostediting}
...
As linguistics quality is not the focus of this work, we apply the general textual quality judgement described in \cite{zaidan-callisonburch:2011:ACL-HLT2011a}. We use the following criteria as indicators of the quality of the generations:
