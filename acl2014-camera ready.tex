...
\author{Rui Yan, Ellie Pavlick, and Chris Callison-Burch \\
...
This drastically limits the languages that SMT can be successfully applied to.
Because of this, collecting parallel corpora for minor languages has become an interesting research challenge. There are various options for creating training data for new language pairs.  Past approaches have examined harvesting translated documents from the web \cite{a10,a13,smith-EtAl:2013:ACL}, or discovering parallel fragments from comparable corpora \cite{a11,abdulrauf-schwenk:2009:EACL,a12}.  Relatively little consideration has been given to creating parallel data from scratch by hiring professional translators.  The costs of professional translation are prohibitively high, even to create a relatively modestly sized parallel corpus, like  \newcite{a25}'s attempt to create a Tamil-English corpus at \$0.36/word.  
